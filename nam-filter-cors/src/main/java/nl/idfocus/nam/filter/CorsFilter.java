/*
 * This code is based on the default Tomcat CORS filter from the 8.0.x branch: 
 * http://svn.apache.org/repos/asf/tomcat/tc8.0.x/trunk/java/org/apache/catalina/filters/CorsFilter.java
 */
...
public class CorsFilter implements Filter
{
	 ...
	 */
	protected static final Collection<String>	SIMPLE_HTTP_REQUEST_CONTENT_TYPE_VALUES	= new HashSet<>(
			...
			final FilterChain filterChain) throws IOException, ServletException
	{
		...
		switch (requestType)
		{
			case SIMPLE:
			case ACTUAL:
				// Handles a Simple or an Actual CORS request.
